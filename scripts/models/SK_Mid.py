if __name__ == "__main__":
    ...
    from tsne_kmeans import extract_latents, plot_tsne_kmeans, show_cluster, plot_tsne_only, extract_latents
    ...
    model = UNetAutoencoder.load_from_checkpoint(os.path.join(current_dir, "../../checkpoints/dae/best-DAE.ckpt"))
    model.eval()
